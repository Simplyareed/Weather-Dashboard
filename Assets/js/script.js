...
// Custom API key specifically given allowing the API to be run
    const APIKey = "f707463928e542ec999ba354e7cf4014";

// Search button clicked, function will read city name entered by user
    function getWeather(cityName) {
//   saved city name will execute a current condition to get request from open weather map api
...
//  Save user's search requests and display  under search form
